...
public class ScholarNodeSecondaryIndex extends ScholarNode {
	...
	public ArrayList<String> getAllJournals() { return journals; }

	public void addJournal(Integer index, String key) { journals.add(index, key); }

	public void addJournal(String key) { journals.add(key); }
	...
	public void setChild(Integer index, ScholarNode child)
	{
