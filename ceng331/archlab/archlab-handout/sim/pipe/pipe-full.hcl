...
#                                                                  #
# In this file, I only implemented the CMPQ instruction in the     #
# same way that I implemented in part B. This process has reduced  #
# our CPE value since I used CMPQ instruction instead of RRMOVQ    #
# and SUBQ instructions combined.                                  #
#                                                                  #
####################################################################
####################################################################
